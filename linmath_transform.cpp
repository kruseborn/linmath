...
template <typename T> tvec3<T> project(
	tvec3<T> const & obj,
	tmat4<T> const & model,
	tmat4<T> const & proj,
	tvec4<T> const & viewport
...
tvec4<T> abs(tvec4<T> const &vec) {
	return tvec4<T>{abs(vec.x), abs(vec.y), abs(vec.z), abs(vec.w)};
}
template<typename T>
tvec3<T> abs(tvec3<T> const &vec) {
	return tvec3<T>{abs(vec.x), abs(vec.y), abs(vec.z)};
}
template<typename T>
tvec2<T> abs(tvec2<T> const &vec) {
	return tvec2<T>{abs(vec.x), abs(vec.y)};
}
...
template tvec3<float> unProject(tvec3<float> const & win, tmat4<float> const & model, tmat4<float> const & proj, tvec4<float> const & viewport);
template tmat4<float> call(tmat4<float> const& m);
template tvec3<float> project(tvec3<float> const & obj, tmat4<float> const & model, tmat4<float> const & proj, tvec4<float> const & viewport);
template float distance(tvec3<float> const & p0, tvec3<float> const & p1);
template tvec4<float> abs(tvec4<float> const &vec);
template tvec3<float> abs(tvec3<float> const &vec);
template tvec2<float> abs(tvec2<float> const &vec);
